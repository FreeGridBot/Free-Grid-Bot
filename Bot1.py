...
def buy_active():
    ...
    # REAL
        ...
        # Multi Mix Level 2
            ...
            send_side = "BUY"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_buy_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_buy.get()) * 2 / (float(send_price) * fok_buy_tz))
        ...
        # Multi Mix Level 3
            ...
            send_side = "BUY"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_buy_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_buy.get()) * 3 / (float(send_price) * fok_buy_tz))
        ...
        # Multi Mix Level 4
            ...
            send_side = "BUY"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_buy_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_buy.get()) * 4 / (float(send_price) * fok_buy_tz))
        ...
        # Multi Mix Level 5
            ...
            send_side = "BUY"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_buy_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_buy.get()) * 5 / (float(send_price) * fok_buy_tz))
...
def sell_active():
    ...
    # REAL
        ...
        # Multi Mix Level 2
            ...
            send_side = "SELL"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_sell_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_sell.get()) * 2 / (float(send_price) * fok_sell_tz))
        ...
        # Multi Mix Level 3
            ...
            send_side = "SELL"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_sell_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_sell.get()) * 3 / (float(send_price) * fok_sell_tz))
        ...
        # Multi Mix Level 4
            ...
            send_side = "SELL"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_sell_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_sell.get()) * 4 / (float(send_price) * fok_sell_tz))
        ...
        # Multi Mix Level 5
            ...
            send_side = "SELL"
            send_price = b_main_bp_k.cget("text") % (float(l_price.cget("text")) * fok_sell_tz)
            amount = b_funds_a1_k.cget("text") % (float(e_main_amount_sell.get()) * 5 / (float(send_price) * fok_sell_tz))
        ...
        try:
            ...
            if r.json() ["status"] == "FILLED":
                ...
                if send_side == "BUY":
                    ...
                    """
                    wait = 0
                    t_log_all.insert ("1.0", time.strftime("%d.%m.%y %H:%M:%S") + "  STATUS: EXPIRED 5SEC PAUSE" + "\n")
                    for i in range (0,5):
                        if bot_start == 0:
                            break
                        time.sleep (1)
            ...
            try:
                ...
                if wait > 1:
                    ...
                    t_log_all.insert ("1.0", time.strftime("%d.%m.%y %H:%M:%S") + "  BOT ORDER FAIL PAUSE 3min\n\n") 
